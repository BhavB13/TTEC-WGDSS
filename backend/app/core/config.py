...
class Settings(BaseSettings):
    ...
    TEMPERATURE_AGGREGATION_ENABLED: bool = True
    TEMPERATURE_AGGREGATION_MIN_WEIGHT_COVERAGE_PERCENT: float = 70.0
    TEMPERATURE_AGGREGATION_POLICY_STATUS: str = "PROTOTYPE_UNCONFIRMED"
    ...
    MODEL_TRAINING_START_DATE: str = "2025-10-01"
    MODEL_TRAINING_END_DATE: str = "2026-05-31"
    SIMULATED_LIVE_START_DATE: str = "2026-06-01"
    SIMULATED_LIVE_END_DATE: str = "2026-06-30"
    JUNE_REPLAY_ARCHIVE_START_DATE: str = "2026-06-01"
    JUNE_REPLAY_ARCHIVE_END_DATE: str = "2026-06-30"
